...
st.markdown(
    ...
    <div class="problem-statement">
        ...
        <p>Rapid urbanization necessitates sustainable development. How can smart technologies and green principles be
        integrated to create environmentally friendly, resource-efficient, and livable future cities?</p>
    </div>
    """,
    unsafe_allow_html=True,
)
...
with st.sidebar:
    ...
    st.markdown("**DY Patil School of Engineering**")
    st.markdown("*Affiliated to Savitri Phule Pune University*")
...
st.markdown(
    ...
    <div style='text-align: center; color: #666; padding: 1rem;'>
        <p><strong>DY Patil School of Engineering</strong></p>
        <p>Empowerment through quality technical education</p>
        <p>Approved by AICITE, Affiliated to Savitri Phule Pune University</p>
    </div>
    """,
    unsafe_allow_html=True,
)
